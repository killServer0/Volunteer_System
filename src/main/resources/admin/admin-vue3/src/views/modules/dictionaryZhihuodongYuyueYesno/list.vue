    ...
    <div class="main-content">
        ...
        <el-form :inline="true" :model="searchForm" class="form-content"
            ...
            <el-row :gutter="20" class="slt"
                ...
                <el-form-item :label="contents.inputTitle == 1 ? '预约状态' : ''">
                    <el-input v-model="searchForm.indexNameSearch" placeholder="预约状态" clearable
            ...
            <el-row class="ad"
                ...
                <el-form-item>
                    <el-button v-if="isAuth('dictionaryZhihuodongYuyueYesno', '新增')" type="success"
                    ...
                    <el-button v-if="isAuth('dictionaryZhihuodongYuyueYesno', '删除')"
        ...
        <div class="table-content">
            <el-table v-loading="dataListLoading" :data="dataList" border
                ...
                <el-table-column type="index" label="序号" width="50" v-if="contents.tableIndex" />
                <el-table-column prop="codeIndex" label="状态编码" align="center" :sortable="contents.tableSortable"
                    :align="contents.tableAlign" />
                <el-table-column prop="indexName" label="状态名称" align="center" :sortable="contents.tableSortable"
                    :align="contents.tableAlign" />
                <el-table-column label="操作" width="300" align="center">
                    <template #default="scope">
                        <el-button v-if="isAuth('dictionaryZhihuodongYuyueYesno', '查看')" type="success" size="small"
                        ...
                        <el-button v-if="isAuth('dictionaryZhihuodongYuyueYesno', '修改')" type="primary" size="small"
                        ...
                        <el-button v-if="isAuth('dictionaryZhihuodongYuyueYesno', '删除')" type="danger" size="small"
...
import { getList, deleteData } from '@/api/dictionaryZhihuodongYuyueYesno'
