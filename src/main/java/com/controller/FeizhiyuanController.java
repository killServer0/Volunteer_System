    ...
    */
    ...
    public R save(@RequestBody FeizhiyuanEntity feizhiyuan, HttpServletRequest request){
        ...
        if(feizhiyuanEntity==null){
            ...
            return R.error(511,"账户或者游客手机号或者游客身份证号已经被使用");
        }
    }
...
//                            feizhiyuanEntity.setFeizhiyuanName(data.get(0));                    //游客姓名 要改的
//                            feizhiyuanEntity.setFeizhiyuanPhone(data.get(0));                    //游客手机号 要改的
//                            feizhiyuanEntity.setFeizhiyuanIdNumber(data.get(0));                    //游客身份证号 要改的
//                            feizhiyuanEntity.setFeizhiyuanPhoto("");//详情和图片
//                            feizhiyuanEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            feizhiyuanEntity.setFeizhiyuanEmail(data.get(0));                    //游客邮箱 要改的
//                            feizhiyuanEntity.setCreateTime(date);//时间
                        ...
                        if(feizhiyuanEntities_feizhiyuanPhone.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [游客手机号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //游客身份证号
                        ...
                        if(feizhiyuanEntities_feizhiyuanIdNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [游客身份证号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(feizhiyuan.getId(),username, "feizhiyuan", "游客");
        R r = R.ok();
        r.put("token", token);
        r.put("role","游客");
...
//    	ValidatorUtils.validateEntity(user);
        ...
        FeizhiyuanEntity feizhiyuanEntity = feizhiyuanService.selectOne(queryWrapper);
        if(feizhiyuanEntity != null)
            return R.error("账户或者游客手机号或者游客身份证号已经被使用");
        feizhiyuan.setCreateTime(new Date());
        feizhiyuanService.insert(feizhiyuan);
