    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            //级联表 志愿者
            //级联表
            ZhiyuanzheEntity zhiyuanzhe = zhiyuanzheService.selectById(forum.getZhiyuanzheId());
            if(zhiyuanzhe != null){
...
, "usersId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            ...
            //级联表 游客
            //级联表
            FeizhiyuanEntity feizhiyuan = feizhiyuanService.selectById(forum.getFeizhiyuanId());
            if(feizhiyuan != null){
...
//                            forumEntity.setZhiyuanzheId(Integer.valueOf(data.get(0)));   //志愿者 要改的
//                            forumEntity.setFeizhiyuanId(Integer.valueOf(data.get(0)));   //游客 要改的
